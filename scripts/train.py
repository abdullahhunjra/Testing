...
for name, model in models.items():
    ...
    print(f"🔍 Loading selected features for {name} from S3...")
...
bars = plt.bar(recall_scores.keys(), recall_scores.values(), color="skyblue")
...
print("✅ All models trained, evaluated, and saved to S3.")
